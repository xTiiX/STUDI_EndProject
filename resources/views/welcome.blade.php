            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-9 flex flex-col text-gray-800 dark:text-white items-center">
                    ...
                    <div class="mt-4 text-lg">
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ url('/dashboard') }}" class="text-sm text-gray-600 dark:text-gray-500 underline">Tableau de bord</a>
                            @else
                                <a href="{{ route('login') }}" class="text-sm text-gray-600 dark:text-gray-500 underline">Connexion</a>
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-600 dark:text-gray-500 underline">Enregistrement</a>
                                @endif
                            @endauth
                        @endif
                    </div>
