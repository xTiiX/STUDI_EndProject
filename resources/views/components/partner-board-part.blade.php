...
@endif
    <div class="p-6">
        <div class="flex">
            ...
            <div class="flex grow">
                <div>
                    <a href="{{ route('partners.index_partner', $partner->id) }}"><p class="text-lg underline">{{ $partner->short_desc }}</p></a>
                    <p class="text-xs">Relier à : {{ $partner->linkUser()->first()->first_name }} {{ $partner->linkUser()->first()->last_name }}</p>
                </div>
                <div class="grow"></div>
